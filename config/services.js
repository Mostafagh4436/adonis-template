...
module.exports = {
  /*
   ...
   |--------------------------------------------------------------------------
   |
   | You can access your application credentials from the firebase developers
   |
   */
  fcm: {
  ...
  ally:
    {
      ...
      facebook: {
        ...
        clientSecret:
          Env.get('FB_CLIENT_SECRET'),
        redirectUri :
          `${ Env.get('APP_URL') }/authenticated/facebook`,
      }
      ,
      ...
      google: {
        ...
        redirectUri :
          `${ Env.get('APP_URL') }/authenticated/google`,
      }
      ,
      ...
      github: {
        ...
        redirectUri :
          `${ Env.get('APP_URL') }/authenticated/github`,
      }
      ,
      ...
      instagram: {
        ...
        redirectUri :
          `${ Env.get('APP_URL') }/authenticated/instagram`,
      }
      ,
      ...
      foursquare: {
        ...
        clientSecret:
          Env.get('FOURSQUARE_SECRET'),
        redirectUri :
          `${ Env.get('APP_URL') }/authenticated/foursquare`,
      },
    },
}
